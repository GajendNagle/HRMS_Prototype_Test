    ...
    <div class="card mt-3 shadow">
        ...
        <div class="card-body">
            ...
            <div id="generateorder" style="display: none; text-align: center">
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">GET DSC</button>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" data-bs-dismiss="modal" ononchange="toggleDivVisibility1()">Submit</button>
