...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <div class="card mt-3 shadow">
        ...
        <div class="card-body">
            ...
            <br />
            <fieldset>
                <legend>Employee Name / Unique ID
                </legend>
                <div class="row mt-2">
                <div class="col-md-3">
            ...
            <div id="EmpPersonalInfo" >
                <fieldset>
                <legend>Current Office Locaiton
                </legend>
                <div class="row mt-2">
               <div class="col-md-3">
                        <div class="form-group">
              ...
              <div class="col-md-3">
                            <div class="form-group">
                                <label>District Name /<br /> जिले  का नाम <span style="color: red">*</span></label>
                 ...
                 <br />
                     ...
                     <div class="col-md-3">
                        <label class="font-bold">
                          Employee To Be Placed In <br />Which Month's Pay Bill<span style="color: red">*</span></label>
                ...
                <table class="table table-bordered text-center">
                    <tbody>
                        <tr>
                            ...
                            <th>Employee ID-Name<br />कर्मचारी का आईडी-नाम</th>
                            <th>Current OIS-Udise Code<br />वर्तमान ओ.आई.एस.कोड</th>
                            <th>Current Sankul Code <br />वर्तमान संकुल कोड</th>
                             <th>New OIS-Udise Code<br />नवीन ओ.आई.एस.कोड</th>
                            <th>New Sankul Code <br />नवीन संकुल कोड</th>
