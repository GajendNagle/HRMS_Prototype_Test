...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Leave Allocation Master</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Leave Allocation Master</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Leave Days Period Wise<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-3 mt-4 ">
                        <div class="form-group">
                            ...
                            <a href="Mst_LeaveAllocation.aspx" class=" btn btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </div>
            </fieldset>
