        ...
        <div class="card-body">
            ...
            <div class="container-fluid " hidden="hidden" id="divRegisrationUpdate">
                ...
                <div class="card-body ">
                    ...
                    <div class="alert alert-success mt-4" style="text-align: left;">
                        <b><strong style="color: white;">Job Status / जॉब की स्थिति</strong></b>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>
                                <b style="color: black;">Enter Job Status / जॉब की स्थिति दर्ज करें</b>  <span style="color: Red;">*</span></label>
                        ...
                        <div id="divApattiHai" style="display: none">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>
                                            <b>Appointment Letter No. / नियुक्ति पत्र संख्या :</b><span style="color: Red;">*</span>
                                        </label>
                                        <asp:TextBox runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>
                                            <b>Appointment Order No. / नियुक्ति आदेश संख्या :</b><span style="color: Red;">*</span>
                                        </label>
                                        <asp:TextBox runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>
                                            <b>Date of Letter / पत्र की तारीख :</b><span style="color: Red;">*</span>
                                        </label>
