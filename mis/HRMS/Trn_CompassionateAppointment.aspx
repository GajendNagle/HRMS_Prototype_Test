...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-12">
                    <h5 class="card-title">Register Application For Compassionate Appointment / अनुकंपा नियुक्ति के लिए आवेदन पंजीकृत करें</h5>
                </div>
            </div>
        </div>
        <div class="card-body">
...
Name of the Applicant Family Member for Compassionate Appointment<br />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>
                                            Have All Family Members Consented Affidavit to Applicant For Compassionate Appointment?<br />
