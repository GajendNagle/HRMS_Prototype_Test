...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Employee Report</h4>
        </div>
        ...
        <div class="card-body">
                    ...
                    <%--<div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2">
                                ...
                                <option value="Bhopal">Class 1 </option>
                                <option value="Bhopal">Class 2 </option>
                                <option value="Bhopal">Class 3 </option>
                                <option value="Bhopal">Class 4 </option>
                            </select>
                        </div>
                    </div>--%>
                    <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input id="Checkbox1" checked onclick="Checkedbox1()" type="checkbox" /></legend>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input disabled checked type="checkbox" name="Chk" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend>OFFICIAL DETAILS   
                    <input id="Checkbox2" checked onclick="Checkedbox2()" type="checkbox" /></legend>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input disabled checked type="checkbox" name="ctl00$ContentBody$ctl06" />
            ...
            <div class="row">
               ...
               <input id="Checkbox7" checked onclick="Checkedbox2()" type="checkbox" /></legend>
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input checked type="checkbox" name="ctl00$ContentBody$ctl06" />
                    ...
                    <fieldset>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr style="background:#416a59;color:white" >
                                    <th>Sr.No.</th>
                                    <th>Profile Image</th>
