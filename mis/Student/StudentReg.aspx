               ...
               <div class="row align-items-end">
                   ...
                   <div class="col-md-3">
                       <div class="form-group">
                           ...
                           <input name="ename" type="text" class="form-control" autocomplete="off" placeholder="8956231478"  />
                       </div>
                   </div>
                   <div class="col-md-3">
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3" id="fatherDis" style="display: none;">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" onchange="myFunction3()">
                                    <option value="0">Select</option>
                                    <option value="1">Yes</option>
                                    <option value="2">No</option>
                                </select>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-3" id="Enrollment" style="display: none;">
                            <div class="form-group">
                                ...
                                <input class="form-control" autocomplete="off" placeholder="Enter School Dise Code" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>
                                    Enter  Percentage<br />
                                    प्रतिशत दर्ज करें<span style="color: red">*</span>
                                </label>
