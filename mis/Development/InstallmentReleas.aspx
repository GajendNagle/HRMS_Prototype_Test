...
सरल क्रमांक</th>
                                ...
                                <th style="width:200px;" class="text-center">Remark
                                   ...
                                   <th style="width:50px;">Installment Release <br />किस्त जारी</th>
</tr>
 ...
 <td>
   ...
   <%-- <i class="fa-regular fa-paper-plane-top  fs-13 me-2"></i>--%>  Release </button></td>
                            </tr>
                                                       <tr>
  ...
  <%--   <option value="B">हेंडपंप खनन</option>
     ...
     <%--selection of this next textbox will visible--%>
                               ...
                               <%--<td>
                                ...
                                <td class="text-center"> <a role="button" class="btn btn-info btn-rounded" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
<td>      <textarea class="form-control color-black fw-bold" rows="1" oninput="autoResize(this)" autocomplete="off" placeholder="completed tasks" ></textarea>
                               </td>
                      
                                                           <td>    <button id="BtnBack"  class="Alert-Save btn btn-outline-primary w-lg  fs-13  rounded-4 " type="button">
                                                                 Release </button></td>
                           </tr>
                            <%--<tr>
                <td></td>
