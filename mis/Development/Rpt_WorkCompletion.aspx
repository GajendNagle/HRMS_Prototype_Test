<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_WorkCompletion.aspx.cs" Inherits="mis_Development_Rpt_WorkCompletion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                ...
                <div class="=page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Project Completion Report</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-border-primary">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-7">
                    <h4 class="card-title">Project Completion Report / 
                        परियोजना पूर्णता रिपोर्ट</h4>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <fieldset>
                <legend>Project Completion Report / परियोजना पूर्णता रिपोर्ट</legend>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3">
                        <div class="form-group">
                            <label>
                                ...
                                परियोजना पूर्णता दिनांक<span style="color: red">*</span></label>
            ...
            <fieldset>
                <legend>Project Completion Deatils / परियोजना पूर्णता विवरण</legend>
