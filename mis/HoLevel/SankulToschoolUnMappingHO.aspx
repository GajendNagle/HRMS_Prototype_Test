    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Sankul To School UnMapping Verification</h4>
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Sankul To School UnMapping Verification</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                <fieldset>
                    <legend>Sankul to School UnMapping</legend>
                   ...
                   <asp:TextBox runat="server" ID="txtUdiseCode" CssClass="form-control" placeholder="Enter UDISE Code"></asp:TextBox>
                        ...
                        <div class="col-md-4">
                            <div class="form-group text-center">
                                ...
                                <asp:Button ID="Button2" CssClass="btn btn-danger btn-rounded " href="SankulToschoolUnMappingHO.aspx" runat="server" Text="Clear" />
                            </div>
                        </div>
                    </div>
                </fieldset>
                <div class="row form-group">
                    <div class="col-md-12">
                        <fieldset id="report" runat="server" visible="false">
                            <legend>Sankul to School UnMapping Details</legend>
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <td r>Upper Primary with grades 1 to 8 (PRY-UPR)</td>
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            <div class="modal-header" id="myDIV">
                                                                <h4 class="modal-title" id="myLargeModalLabel1">Request Detail</h4>
                        ...
                        <div class="row justify-content-center" runat="server" id="divbtn" visible="false">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group text-center">
                                    <button type="button" class=" btn btn-success btn-rounded " data-bs-toggle="modal" data-bs-target="#OTPModal">School UnMapping</button>
