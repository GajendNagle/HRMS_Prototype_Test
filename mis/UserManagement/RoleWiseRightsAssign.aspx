        ...
        <div class="card-body">
            <fieldset>
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Select  Action Name /<br /> कार्यवाही का चयन करें<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Role Valid Upto(Date) /<br /> रोल (दिनांक) तक मान्य<span style="color: red">*</span></label>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center">
                                <tr>
                                    ...
                                    <th>User Role Name/<br /> उपयोगकर्ता के रोल का नाम </th>
                                    <th>Module Name /<br /> मोड्यूल का नाम</th>
                                    <th>Menu Name /<br /> मेनू का नाम</th>
                                    <th>Action Name /<br /> कार्यवाही का नाम</th>
                                    <th>Role valid Upto(Date) /<br /> रोल (दिनांक) तक मान्य</th>
