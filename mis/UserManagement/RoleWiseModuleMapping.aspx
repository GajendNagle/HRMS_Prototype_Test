...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">Role Wise Module Mapping</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Role Wise Module Mapping</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="card mt-3 shadow">
        ...
        <div class="card-body">
            <fieldset>
                <legend>Role Wise Module Mapping</legend>
                <div class="row">
                    ...
                    <div class="col-md-3 mt-4">
                        <div class="form-group">
                            ...
                            <a href="RoleWiseModuleMapping.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </div>
            </fieldset>
            <fieldset>
                <legend>Role Wise Module Mapping Details </legend>
