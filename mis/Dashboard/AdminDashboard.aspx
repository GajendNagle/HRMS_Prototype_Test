            ...
            <div class="d-flex flex-column h-100">
                <div class="row h-100">
                    <div class="col-xxl-6 col-md-12">
                        <div class="card  card-animate shadow card-border-primary">
                        ...
                        <div class="card card-animate shadow card-border-primary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="fw-bold  mb-0">Registered Offices</h5>
                                        <p class="fw-medium  mb-0">(No's) </p>

                                        <h2 class="mt-4 ff-secondary cfs-22 fw-semibold"><span class="counter-value" data-target="911">0</span></h2>
                                        <p class="mb-0  text-truncate">
                                            Last Updated on <span class="badge bg-light text-dark mb-0">03/06/2024 </span>
                                        </p>
                                    </div>
                                    <div>
                    ...
                    <div class="col-xxl-6 col-md-12">
                        <div class="card card-animate shadow card-border-primary ">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="fw-bold mb-0">Registered Institutes</h5>
                                        <p class="fw-medium  mb-0">(No's) </p>
                                    ...
                                    <div>
                                        <div class="avatar-sm flex-shrink-0">
                                            <span class="avatar-title bg-info-subtle rounded-circle fs-2">
                                                <i class='bx bxs-institution text-info'></i>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xxl-6 col-md-12">
                        <div class="card card-animate shadow card-border-primary ">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="fw-bold  mb-0">Registered Schools</h5>
                                        <p class="fw-medium  mb-0">(No's) </p>
                    ...
                    <div class="col-xxl-6 col-md-12">
                        <div class="card card-animate shadow card-border-primary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="fw-bold  mb-0">Registered Sankuls </h5>
                                        <p class="fw-medium  mb-0">(No's) </p>
                                        <h2 class="mt-4 ff-secondary cfs-22 fw-semibold">
                                            <span class="counter-value" data-target="18088">0</span>
                                        </h2>
                                        <p class="mb-0  text-truncate">
                                            Last Updated on <span class="badge bg-light text-dark mb-0">03/06/2024</span>
                                        </p>
                    ...
                    <div class="col-xxl-6 col-md-12">
                        <div class="card card-animate shadow card-border-primary">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="fw-bold mb-0">Registered Special Schools</h5>
                                        <p class="fw-medium  mb-0">(No's) </p>
        ...
        <div class="col-xxl-5 col-md-12">
            <div class="row h-100">
                <div class="col-xxl-12 col-md-12">
                    <div class="card card-height-100 shadow card-border-primary">
                            ...
                            <div class="row">
                                <div class="col-12 text-center lh-1">
                                    ...
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                        viewBox="50 120 630 460" style="enable-background: new 0 0 720 720; background-color: white" xml:space="preserve">
                                        <style type="text/css">
                                            .st0 {
                                                fill-rule: evenodd;
                                                clip-rule: evenodd;
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Chhindwara-8" title="छिंदवाडा:User - 10" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M421.06,460.92c-3.71-1.18-2.8-0.82-2.7-4.04c0.02-0.74-0.67-6.04-2.64-5.19c-1.62,0.69-0.6,1.34-2.93,1.48
			...
			c-2.22,1.37-4.42,3.06-6.99,3.53c-2.96,5.7-0.81,2.31-5.52,5.84C337.65,338.38,339.68,342.5,337.39,343.22z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st3" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Betul-8" title="बेतुल : User - 325" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M350.63,493.16c-1.51-1.19-1.36,0-2.08-1.89c-2.37-6.17,1.81-2.75,1.31-8.5c-2.52,0.06-6.53-0.27-8.82,1.01
			...
			c1.2-1.54,1.41-1.01,3.33-1.52L542.83,498.43z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st5" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Seoni-8" title="सिवनी : User - 10" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M434.22,458.12l-1.1-0.35l-2.79,0.68c-0.93,2.2-0.59,2.16-2.14,4.02c-1.57,1.89-1.68,1.39-3.21,2.77
			...
			C435.42,458.35,436.13,457.68,434.22,458.12z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Chhatarpur-8" title="छतरपुर : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M434.35,275.65l-1.7,0.73l-1.08-1.36c-0.66,0.94-0.23,0.68-1.57,0.81c-2.42-2.35-1.37-5.66,0.98-7.12
			...
			c-2.18,1.77-2.83,4.94-3.04,5.29C437.47,277.99,433.81,279.61,434.35,275.65z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st5" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Raisen-8" title="रायसेन  : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M363.93,387.99c-1.04-1.98,0.2-1.22-1.16-3.34c-0.76-1.18-1.1-2.27-1.18-2.47l-1.43,1.07
			...
			c-0.99-0.75-2.98-1.1-4.45-2.14C195.27,473.9,197.11,476,195.63,469.17z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Satna-8" title="सतना : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M497.78,308.07l-0.75,0.84l1.85,0.54c2.62,1.81,1.7,1.73,2.7,4.26l2.69-0.1c0.1,3.53-1.53,2.94-0.42,7.81
			...
			C506.62,428.74,506.17,428.65,503.43,427.72z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Damoh-8" title="दमोह  : User - 8" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M408.18,363.37l0.24,0.19c-0.67,2.21-1.74,2.13-2.38,3.54c1.64-0.86,0.12-0.76,1.98-0.51
			...
			c-1.57,0.89-1.6,0.2-3.27,1.48C410.05,362.91,410.07,362.98,408.18,363.37z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Khandwa-8" title="खंडवा : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M191.72,494.47l-0.11,0.96l4.52,0.7l1.21-1.81c1.71,0,3.71-0.58,4.1,1.13c0.56,2.47-1.37,2.01-2.6,3.1
			...
			C194.14,494.02,193.75,493.48,191.72,494.47z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="Vidisha-8" title="विदिशा : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M297.6,395.98c0.88,0.97,0.72,0.73,1.6,1.46l1.49-0.27c0.95,0.79,3.54,2.93,4.69,2.44
			...
			c-1.89,2.96-0.49,4.39-4.95,5.4C297.22,394.6,296.45,393.94,297.6,395.98z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st7" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="panna-8" title="पन्ना : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25"
...
C501.87,283.1,501.58,283.82,501.02,282.41z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="dewas-8" title="देवास : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M260.27,447.54c-0.89-2.16,0.37-0.89-1.29-1.95c-2.29,1.44-1.27,0.11-2.85,0.66
			...
			c0.16-2.83,1.38-0.9-0.02-3.56C260.55,450.22,260.48,449.37,260.27,447.54z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st6" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="narmadapuram-8" title="नर्मदापुरम : User - 695" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M372.21,450.77c0.33-4.79-0.64-1.43-1.17-4.35c-0.31-1.71,0.83-3.53-0.34-5.34c-1-1.56-3.19-0.85-5.23-1.12
			...
			C372.74,451.67,376.28,453.11,372.21,450.77z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="sheopur-8" title="शेओपुर : User - 12" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M238.24,213.91l-0.88,2.61c-1.99,0.48-1.98-0.94-3.32,0.59c-0.55,0.62-0.82,1.72-1.9,2.95
			...
			C241.98,215.14,241.82,212.88,238.24,213.91z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="sehore-8" title="सीहोर : User - 7" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M276.55,385.98l-3.55-0.87c-4.56,3.99,0.44,5.51-2.17,9.21c-5.69,8.06-0.29,1.48-6.79,7.22
			...
			c3.03-4.06,1.27-4.05,1.43-5.38l3.27-0.77c0.14-0.64,0.23-8.29,0.16-9.25c-0.33-4.53,0.07-4.42-4.36-6.3L276.55,385.98z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="rewa-8" title="रीवा : User - 12" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M547.59,297.23l-1.11,0.45c-0.06,2.07,0.13,0.86-0.5,2.07c-1.69-0.49-0.84-0.26-0.78,0.92
			...
			C547.71,297.36,548.35,296.36,547.59,297.23z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="guna-8" title="गुना  : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M281.68,353.14c-0.04-2.32-1-1.56,0.34-3.64c1.38-2.15,0.69-0.24,0.38-2.66l2.81-1.12l-0.19-3.11
			...
			C278.23,354.28,279.36,354.44,281.68,353.14z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="rajgarh-8" title="राजगढ़ : User - 7" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M244.85,347.34c-1.61-0.7-4.1,1.39-5.76-2.24c-1.37-3,2.1-2.16,0.96-6.31c-1.13,0.92-0.87,0.56-2.15,0.71
			...
			c-3.51-2.05-1.41,0.08-3.55-3.26c-2.35,0.47-2.62,1.17-5.28,1.21C245.91,349.23,246.23,348.28,244.85,347.34z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="singrauli-8" title="सिंगरौली  : User - 2" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M655.51,307.96c-2.44,1.05-4.63,2.42-7.2,2.79c-1.2-1.01-0.11-2.68-5.78-1.86c-0.68-1.43-0.05-2.22-1.57-1.9
			...
			C136.89,419.37,137.55,422.51,138.04,423.13z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st6" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="dindori-8" title="डिंडोरी  : User - 3" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M526.29,420.56c-1.33,0.08-2.26,0.19-3.03-1.23l-1.3-2.31c-2.97-4.26,5.61-4.42-0.62-7.24
			...
			c-4.06,2.35-1.93,3.42-6.78-0.22C526.74,419.43,527.53,419.16,526.29,420.56z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="mandsaur-8" title="मंदसौर  : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M178.4,353.51l1.09-1.06l0.11-1.56l-1.95-0.22c-1.98-0.58-0.47-1.24-3.32-2.41c-0.09-0.04-0.3,0.03-0.37-0.13
			...
			L178.4,353.51z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="shahdol-8" title="शहडोल  : User - 7" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M589.06,397.14c-0.93,0.16-0.54-0.06-1.17,0.58c-0.51,1.5-1.05,1.74-2.61,1.99
			...
			c-6.3-0.8-1.72-1.05-4.68-1.3C591.57,395.87,591.99,397.33,589.06,397.14z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="barwani-8" title="बरवानी : User - 7" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M147.98,505.63l-1.18-0.49c-1.89-1.46-0.04,0.08-0.45-2.08l-3.01-1.74c-3.44-2.25-10.8,0.81-11.16,0.85
			...
			c0.72-1.56,0.54-0.29,0.77-2.72c4.23-0.75,1.72,0.42,5.07-2.03C148.07,507.44,147.96,507.38,147.98,505.63z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="narsinghpur-8" title="नरसिंहपुर : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M427.05,428.95c-0.96,0.52,0.28,0.61-1.62,0.2c-0.35-1.7-0.41-0.55,0.25-1.55l0.05-1.9l0.15-0.23l-1.32,0.17
			...
			c-1.24-0.12-0.79,0.03-1.73,0.02C427.99,429.51,429.05,429.06,427.05,428.95z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                <path class="st3" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="katni-8" title="कटनी : User - 1" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M519.77,354.03c1.34-2.17,2.1-0.01,3.05-2.55c-3.34-1.9-3.75,3.27-3.77,3.38c-1.63,0.21-0.79-0.14-2.24-0.41			c0.26,1.95,1.51,1.32,0.13,3c-1.9-0.58-0.04-0.88-2.01-2.16l-5.37,3.16c-0.79-1.65,0.58-1.35-0.72-2.1
			...
			c1.96-1.25,2.01,0.27,2.56-1.92C523.84,354.55,520.65,357.62,519.77,354.03z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st6" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="morena-8" title="मोरेना : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M351.5,144.49c-2.32,0.27-1.51-1.67-6.4-0.37c0.03,1.43,0.97,0.57,0.7,2.46c-3.51,1.47-3.25-1.57-5.57,0.11
			...
			c-1.44-0.83-1.79,0.23-3.12-0.75c-1.89-1.4,0.44-3.37-4.07-2.91C351.08,141.35,353.18,141.55,351.5,144.49z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="jabalpur-8" title="जबलपुर : User - 524" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M468.26,394.09c-0.36-1.96,0.58-0.48,0.53-2.54c-2.76,0.07-3.93,1.12-5.41,3.33
			...
			c-1.25-0.08-2.08,1.42-5.42,0.83C470.11,393.73,469.93,394.27,468.26,394.09z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="ratlam-8" title="रतलाम : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M137.02,425.74v-0.2l-0.83-7.99c2.32-1.39,0.74-1.54,3.77-0.55c-0.23-2.31-1.93-0.13-1.02-3.86l4.14-0.87
			...
			c1.82,0.1,2.57,0.22,4.26,0.44c2.13,0.27,2.34-0.29,4.11-0.14c3.6,0.3,4.65,1.33,8.2,1.88L137.02,425.74z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st3" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="ashoknagar-8" title="अशोकनगर : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M303.11,289.59c-0.63-0.36-0.42,0.07-0.71-0.51l-0.9,1.66c0.76,1.71-0.18,0.15,1.71,1.31
			...
			C306.7,291.91,304.64,289.76,303.11,289.59z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st7" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="gwalior-8" title="ग्वालियर : User - 21" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M333.22,183.03c-0.96,2.43,1.28,5.16-3.42,4.97c-5.82-0.24-3.4,2.74-8.05,2.61l-1.22-2.65
			...
			c-2.9-0.94-2.45-3.08-6.3-1.97C337.48,182.7,336.41,183.39,333.22,183.03z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st9" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="umaria-8" title="उमरिया : User - 3" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M553.04,367.25c-1.84-0.84-1.72,0.33-2.75-1.27c-0.85-1.32,0.07-1.13-0.72-2.41l-3.62,0.15
			...
			c-3.23-1.64-0.79,2.01-4.03-2.44C550.27,370.84,552.92,368.26,553.04,367.25z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="sidhi-8" title="सीधी : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M625.65,314.46c-4.28,0.18-3.9,1.15-8.9,0.34c-2.15,3.32-1.5,1.07-4.98,2.85c-4.06,2.08-2.82,0.3-5.09-0.21
			...
			c-2.06-0.15-1.59,0.19-3.54-0.46l-2.86-0.93C626.07,314.15,626.27,313.78,625.65,314.46z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st0" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="bhind-8" title="भिंड : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M369.33,155.18c-2.35,1.37-2.79-0.55-4.16,1.42c-0.77,1.11-1,1.09-1.67,1.89c-1.21,1.45-0.6,1.54-1.5,3.11
			...
			C367.84,148.55,369.62,153.39,369.33,155.18z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="neemach-8" title="नीमच : User - 3" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M131.46,284.11c-0.06,2.21,0.36,4.29-0.25,6.42c-2.29,0.69-2.23,0.13-2.85,0.22
			...
			C134.46,281.94,137.3,281.56,131.46,284.11z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st7" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="indore-8" data-html="true" title="इंदौर : User - 638" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M199.96,464.37l0.42-0.77c0.45-1.78,0.45-0.66,2.79-1.58c0.89,1.73-0.11,0.62,0.13,1.82
			...
			c2.19-1.14,0.62,0.83,2.2-0.9c0.76-0.84,0.99-1.29,1.65-1.81C196.86,464.4,197.74,465.51,199.96,464.37z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st3" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="tikamgarh-8" title="टीकमगढ़  : User - 7" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M400.47,265.34c1.29,1.87,2.2,0.52,1.61,4.42c-3.08-0.16-2.13-3.53-5.28-0.94c-1.02,0.84-5.91,7.85-7.45,8.79
			...
			C400.73,264.2,401.14,263.93,400.47,265.34z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st5" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="anuppur-8" title="अनुपपुर : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M619.44,409.72c-0.95-3.25-0.26-3.59-3.45-2.1c-2.49,1.17-3.55,0-2.9-2.46l-2.59,0.59
			...
			c0.09-0.1,1.51-2.13,1.62-2.31c-3.41-5.34,2.84-8.36,2.49-12.65C619.23,408.04,622.31,410.26,619.44,409.72z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st4" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="shahjapur-8" title="शाजापुर : User - 5" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M234.42,393.63c-1.95-0.92-0.6-0.05-2.17,0.05c-1.5,0.09-3.28-1.75-5.09-1.16c-0.42,1.5,0.72,1.81-0.85,4.17
			...
			c-1.33-0.01-2.86,0.47-3.93,0.38c-1.72-0.15-0.71-0.67-3.4-0.94l0.09-2.67C236.19,394.62,234.97,393.89,234.42,393.63z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="jhabua-8" title="झाबुआ : User - 6" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M106.95,419.81c0.72-1.28,1.74-1.17,0.99-3.08c0,0,0.61-1.18-1.02-0.67c-0.96,0.3-0.08-0.08-0.86,1.09
			...
			C108.87,423.7,108.41,423.13,106.95,419.81z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st1" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="harda-8" title="हरदा : User - 1" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M278.05,470.28c-1.39-0.42-1.68-0.07-2.83-0.68c-1.56-0.83-2.64-3.86-6.4,0.13
			...
			c-0.67-4.71,0.9-2.23-2.35-5.75L278.05,470.28z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="alirajpur-8" title="अलीराजपुर : User - 2" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M100.39,475.93c-0.52-1.9-2.32-0.82-1.53-4.25c0.4-1.7,1.54-4.18,1.81-5.21l-3.39-1.7
			...
			C98.64,476.64,94.86,479.12,100.39,475.93z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st8" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="burhanpur-8" title="बुरहानपुर : User - 2" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M244.37,550.1c-0.68-1.12-1.66-1.2-1.69-2.29c-0.04-1.5,0.62-0.26,1.44-2l-3.4-1.91
			...
			z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st5" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="datia-8" title="दतिया : User - 3" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M389.04,192.84l-0.29-0.92c-0.79-1.34-0.99-0.86-2.32-1.81c0.49-1.77,2.36-1.5,2.93-3.95
			...
			c-0.73-0.43-1.23-0.57-1.63-1.61c1.06-1.39,1.66-0.94,2.85-1.62c-1.35-1.36-2.1-3.05-2.72-4.91L389.04,192.84z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st6" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="agarmalwa-8" title="आगरमालवा  : User - 4" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M208.19,348.45c-0.84-1.88-1.37,0.14-1.43-2.86c-0.05-2.34-0.03-1.56-0.6-3.7c-1.61-6.02,0.55-5.34-1.1-7.22
			...
			C302.01,414.35,300.23,412.8,304.24,411.1z" />
                                        ...
                                        <a xlink:href="#">
                                            <g>
                                                ...
                                                <path class="st6" ng-class="allStateStatus.x8.stateMap" ng-click="getStatistics($event)" data-target="#carouselExampleIndicators" data-slide-to="1" id="niwari-8" title="निवारी  : User - 1" onmouseover="showTitle(evt)" fill="#DB96C2" stroke="#010101" stroke-width="0.25" d="M367.95,261.55l-0.21,0.21c0.54,0.45-0.19-0.11,0.7,0.41l3.54,1.83c0.66,2.03-0.75,2.37,0.96,5.98
			...
			c-0.3,0.57-0.82,1.28-1.02,1.63c-1.12,2.01,0.4,5-3.6,2.49C369.69,259.35,371.55,260.56,367.95,261.55z" />
                                    ...
                                    <%--<img src="/assets/images/MPMap.gif" height="280" style="max-width: inherit;" />--%>
                                </div>
    ...
    <div class="row">
        <div class="col-xxl-7 col-md-12 h-auto">
            <div class="row h-100">
                <div class="col-xxl-6 col-md-12 h-auto">
                    <div class="card card-height-100 card-border-primary shadow">
                        <div class="card-header border-0 align-items-center d-flex ">
                            <h4 class="card-title mb-0 flex-grow-1">Upcoming Retirements</h4>
                        </div>
                        <!-- end card header -->
                        <div class="card-header p-0 border-0 bg-light-subtle border card-border-primary">
    ...
    <div class="col-xxl-5 col-md-12">
        <div class="card card-height-100 shadow card-border-primary">
            ...
            <div class="card-body p-0 pb-2">
                ...
                <%--<img src="/mis/assets/images/Calender.png" style="width: 100%; max-height: 380px" />--%>
    ...
    <div class="row">
      ...
      <div class="card card-height-100 shadow card-border-primary">
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-12">
                      <p class=" mb-0">Total Employee Transfer (No's)</p>
                      <h5 class="mb-1">
                  ...
                  <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                      <tbody class="border-0">
                          <tr>
                              ...
                              <td class="text-end">
                                  <p class=" mb-0"><i data-feather="users" class="me-2 icon-sm"></i>854</p>
                              </td>
                          ...
                          <tr>
                              ...
                              <td class="text-end">
                                  <p class=" mb-0"><i data-feather="users" class="me-2 icon-sm"></i>505</p>
                              </td>
  ...
  <div class="col-xxl-4 col-md-12">
      ...
      <div class="card card-height-100 shadow card-border-primary">
          ...
          <div class="card-body">
              <div class="row">
                  <div class="col-12">
                      <p class=" mb-0">Total Registered Staff (No's)</p>
                      <h5 class="mb-1">
                        ...
                        <table class="table align-middle table-borderless table-striped table-centered  mb-0 ">
                            <thead class=" table-light">
                                <tr>
                                    ...
                                    <th scope="col" style="width: 80%; text-align: center;">Order Details</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        Highcharts.chart('SchemeApplicants_Charts', {
            ...
            series: [{
                name: 'Students',
                data: [{ name: 'Sudama Pre Matric Scheme', y: 70, z: 50 },
                ...
                dataLabels: {
                    enabled: true,
                    formatter: function () { return 'Students: ' + (this.y + this.point.z); }
                },
                tooltip: {
                    pointFormatter: function () {
                        return 'Total Students: <b>' + (this.y + this.z) + '</b><br>' +
                            'Boys: <b>' + this.y + '</b><br>' +
                            'Girls: <b>' + this.z + '</b><br>';
                    }
                },
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                    //{ id: 1, title: "World Braille Day", start: "2024-06-04", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 2, title: "World Leprosy Day", start: "2024-06-30", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 3, title: "International Mother Language Day", start: "2024-06-21", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 4, title: "International Women's Day", start: "2024-06-08", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 5, title: "World Thinking Day", start: "2024-06-24", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 7, title: "World Water Day", start: "2024-06-23", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 8, title: "World Health Day", start: "2024-06-07", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 9, title: "International Special Librarians Day", start: "2024-06-16", className: "bg-info-subtle", allDay: !0 },
                    //{ id: 10, title: "Earth Day", start: "2024-06-12", className: "bg-info-subtle", allDay: !0 }
                ],
