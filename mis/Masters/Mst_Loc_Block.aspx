...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Block Master</h4>
            </div>
            ...
            <div class="card-body ">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label class="font-weight-bold">Block Name (In English)<span style="color: red">*</span></label>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label class="font-weight-bold">विकासखंड का नाम(हिंदी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="विकासखंड का नाम दर्ज करे" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">Block Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 mt-4">
                            ...
                            <a href="Mst_Loc_Block.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Block  Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Block Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>विकासखंड का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Block Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
