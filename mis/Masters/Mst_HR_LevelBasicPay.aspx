    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Level Basic Pay Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Level Basic Pay Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Level Basic Pay Master</legend>
                    <div class="row form-group">
                        ...
                        <div class="col-md-1 mt-4">
                            <a href="Mst_HR_LevelBasicPay.aspx" class="btn btn-block btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>

                </fieldset>
                <fieldset>
                    <legend>Level Basic Pay Details</legend>
                        ...
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to select<strong> Level Name </strong>from dropdown. and data populated from <strong>Level Name Master</strong>  </li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to enter the <strong>Basic Pay</strong> and the text field should accept <strong>Decimal Values only.</strong> </li>
                                    </ul>
