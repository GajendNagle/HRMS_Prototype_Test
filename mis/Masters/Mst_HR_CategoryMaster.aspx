    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Caste Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Caste Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Caste Master</legend>
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label>Caste (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl00" type="text" class="form-control" placeholder="Enter Caste Name" onkeypress="return hindiOnly();" />
                        </div>
                        <div class="col-md-3">
                            <label>वर्ग का नाम (हिंदी में) <span style="color: red">*</span></label>
                        ...
                        <div class="col-md-2">
                            <label>Caste Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <button type="button" class="Alert-Confirmation btn btn-success btn-rounded">Save</button>
                              <a href="Mst_HR_CasteMaster.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
