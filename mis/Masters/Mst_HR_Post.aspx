    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Post Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Post Master</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label class="font-weight-bold">Post Name (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl00" type="text" class="form-control" autocomplete="off" placeholder="Enter Post Name" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">पद का नाम (हिंदी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl01" type="text" class="form-control" autocomplete="off" placeholder="पद का नाम दर्ज करे" />
                        </div>


                        <div class="col-md-2">
                            <label class="font-weight-bold">Post Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-1 mt-4">
                            <a href="Mst_HR_Post.aspx" class="btn btn-block btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>

                </fieldset>
                <fieldset>
                    <legend>Post Master Details</legend>
               ...
               <%-- <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>Post Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Post Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>पद का नाम(हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Post Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
