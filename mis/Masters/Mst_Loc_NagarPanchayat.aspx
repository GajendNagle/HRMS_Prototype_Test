    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Nagar Panchayat Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Nagar Panchayat Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label class="font-weight-bold">Nagar Panchayat Name (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="Enter Nagar Panchayat Name" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">नगर पंचायत का नाम (हिंदी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl05" type="text" class="form-control" autocomplete="off" placeholder="पंचायत का नाम दर्ज करे" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">Nagar Panchayat Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <a href="Mst_Loc_NagarPanchayat.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    <legend>Nagar Panchayat Details</legend>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Nagar Panchayat Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Nagar Panchayat Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>नगर पंचायत का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Nagar Panchayat Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
