    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">School Incharge Type Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">School Incharge Type Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                <fieldset>
                    <legend>School Incharge Type Master</legend>
                    <div class="row">

                        <div class="col-md-3">
                            <div class="form-group">
                                <label>School Incharge Type Name<span style="color: red">*</span></label>
                                <input type="text" class="form-control" autocomplete="off" placeholder="Enter School Incharge Type " />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>स्कूल प्रभारी का प्रकार नाम<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Incharge Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_Off_SchoolInchargeType.aspx" class="btn btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    <legend>School Incharge Type Master Details </legend>
              ...
              <%--  <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>School Incharge Type Name (In English) </strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>School Incharge Type Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>स्कूल प्रभारी का प्रकार नाम(हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>School Incharge Type Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
