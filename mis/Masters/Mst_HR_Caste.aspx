    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Religion Master</h4>
            </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Religion Master</legend>
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label>Religion (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label>धर्म का नाम (हिंदी में) <span style="color: red">*</span></label>
                        ...
                        <div class="col-md-1">
                            <label>Is Active<i style="color: red;">*</i></label>
                        ...
                        <div class="col-md-1 mt-4">
                            <a href="Mst_HR_Caste.aspx" class="btn btn-block btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to enter the <strong>Religion Name In English</strong> and the text field should accept <strong>English Character Only.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>जाति का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Religion Name In Hindi</strong> and the text field should accept <strong>Hindi Character Only.</strong> </li>
                                    </ul>
