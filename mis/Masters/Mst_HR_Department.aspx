    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Appointment Department Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Appointment Department Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Appointment Department Master</legend>

                    <div class="row form-group">
                        <div class="col-md-3">
                            <label>Department of Appointment<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label>Appointed Department Code No.<span style="color: red">*</span></label>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-1">
                            <a href="Mst_HR_Department.aspx" class="btn btn-block btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th>Appointed Department Code No.</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Department of Appointment</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Department of Appointment In English</strong> and the text field should accept <strong>English Character Only.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>नियुक्ति विभाग का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Department of Appointment In Hindi</strong> and the text field should accept <strong>Hindi Character Only.</strong> </li>
                                    </ul>
