    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Designation Type Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Designation Type Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Designation Type Master</legend>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Designation Type (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Designation Type Code No.</label>
                        ...
                        <div class="col-md-2 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_HR_DesignationType.aspx" class=" btn btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th>Designation Type Code No.</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    <tr>
                ...
                <%--<fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>Designation Type (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Designation Type in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>पदनाम का प्रकार (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Designation Type  in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
