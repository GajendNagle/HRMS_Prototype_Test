             ...
             <%--   <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>Office Type  Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Office Type  Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>कार्यालय प्रकार का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Office Type  Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>

                                </li>

                                <li>
                                    <strong>Office Type Code</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Office Type Code</strong> and the text field should accept<strong> only numerical values</strong>.</li>
                                    </ul>
