    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Assembly Master</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Assembly Name (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Assembly Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_Loc_Assembly.aspx" class="btn btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th>Division Name </th>
                                        <th>District Name</th>
                                        <th>Assembly Name (In English)</th>
                                        <th>विधानसभा का नाम(हिंदी में)</th>
                                        <th>Assembly Code No.</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Assembly Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Assembly Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>विधानसभा का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Assembly Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
