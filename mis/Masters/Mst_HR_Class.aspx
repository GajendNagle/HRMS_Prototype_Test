    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Class Master</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="row form-group">
                        <div class="col-md-3">
                            <label>Class Name (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-1 mt-4">
                            <a href="Mst_HR_Class.aspx" class="btn btn-block btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                ...
                <%--<fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>Class Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Class Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to enter the <strong>Class Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
