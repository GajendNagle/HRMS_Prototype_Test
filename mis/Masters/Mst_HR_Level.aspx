    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Level Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Level Master</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="Mst_HR_Level.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                        ...
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to enter the <strong>Grade Level</strong> and the text field should accept <strong>Alphanumeric & Speacial character (-) only.</strong> </li>
                                    </ul>
