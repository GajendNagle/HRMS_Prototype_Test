    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Gram Panchayat Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Gram Panchayat Master</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="font-weight-bold">Gram Panchayat Name (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="font-weight-bold">ग्राम पंचायत का नाम (हिंदी में)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="font-weight-bold">Gram Panchayat Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_Loc_GramPanchayat.aspx" class="btn  btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    <legend>Gram Panchayat Details</legend>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Gram Panchayat Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Gram Panchayat Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>ग्राम पंचायत  का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Gram Panchayat Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
