        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-3 form-group">
                            <label class="font-weight-bold">Janpad Panchayat Name (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="Enter Janpad Panchayat Name" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">जनपद पंचायत का नाम (हिंदी में)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl05" type="text" class="form-control" autocomplete="off" placeholder="जनपद पंचायत का नाम दर्ज करे" />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">Janpad Panchayat Code No.<span style="color: red">*</span></label>
                ...
                <fieldset>
                    <legend>Janpad Panchayat Details</legend>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th>Janpad Panchayat Code No.</th>
                                        <th>Status</th>
                                        <th>Action</th>
                                    </tr>
                                    <tr>
