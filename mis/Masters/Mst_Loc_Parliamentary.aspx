    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Parliamentary Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Parliamentary Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                <fieldset>
                    <legend>Parliamentary Master</legend>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>संसद का नाम(हिंदी में)<span style="color: red">*</span></label>
                                <input name="ctl00$ContentBody$ctl04" type="text" class="form-control" autocomplete="off" placeholder="संसद का नाम दर्ज करे" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Parliamentary Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_Loc_Parliamentary.aspx" class="btn btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    <legend>Parliamentary  Details </legend>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Parliamentary  Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Parliamentary  Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>संसद  का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Parliamentary  Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
