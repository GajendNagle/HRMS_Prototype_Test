                ...
                <div class="row align-items-end">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Board Name (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl00" type="text" class="form-control" autocomplete="off" placeholder="Enter Board Name " />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>बोर्ड का नाम (हिंदी में)<span style="color: red">*</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>
                                Board Code No. /<br />
                                बोर्ड कोड संख्या<span style="color: red">*</span></label>
