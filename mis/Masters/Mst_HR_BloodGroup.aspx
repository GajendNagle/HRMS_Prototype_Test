    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Blood Group Master</h4>
            </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Blood Group Master</legend>
                    <div class="row form-group">
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <input id="ContentBody_ctl01" type="checkbox" name="ctl00$ContentBody$ctl01" checked="checked" />
                        </div>
                        <div class="col-md-3 mt-4">
                            <button type="button" class="Alert-Confirmation btn btn-success btn-rounded">Save</button>
                                 <a href="Mst_HR_BloodGroup.aspx" class="btn btn-danger btn-rounded">Clear</a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    <strong>Blood Group Name</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Blood Group Name </strong>and the text field should accept <strong>Alphabetical & Special Characters Only.</strong> </li>
                                    </ul>
