    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">School Category Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">School Category Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>School Category Master</legend>


                    <div class="row">

                        <div class="col-md-3 form-group">
                            <label class="font-weight-bold">Category Name (In English)<span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl00" type="text" class="form-control" autocomplete="off" placeholder="Enter Category Name " />
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold">श्रेणी का नाम (हिंदी में) <span style="color: red">*</span></label>
                            <input name="ctl00$ContentBody$ctl01" type="text" class="form-control" autocomplete="off" placeholder="श्रेणी का नाम दर्ज करे" />
                        </div>

                        <div class="col-md-3">
                            <label class="font-weight-bold">School Category Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3 ">
                            ...
                            <a href="Mst_Off_SchoolCategory.aspx" class="btn  btn-danger btn-rounded">Clear</a>
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                ...
                <%--<fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="main-ul">
                                <li>
                                    <strong>Category Name  (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Category Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>श्रेणी का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Category Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
