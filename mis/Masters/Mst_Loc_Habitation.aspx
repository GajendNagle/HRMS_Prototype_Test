    ...
    <div id="dv_Masters_LocationMasters" runat="server">
        ...
        <div class="row page-titles mb-4">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor ">Habitation Master</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Habitation Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <fieldset>
                    <legend>Habitation Master</legend>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Gram Panchayat Name<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Habitation Name (In English)<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>बस्ती का नाम (हिंदी में)<span style="color: red">*</span></label>
                                <input name="ctl00$ContentBody$ctl06" type="text" class="form-control" autocomplete="off" placeholder="बस्ती का नाम दर्ज करे" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label>Habitation Code No.<span style="color: red">*</span></label>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <br />
                                <input id="ContentBody_ctl08" type="checkbox" name="ctl00$ContentBody$ctl08" checked="checked" />
                            </div>
                        </div>
                        <div class="col-md-3 mt-4">
                            <div class="form-group">
                                ...
                                <a href="Mst_Loc_Habitation.aspx" class="btn btn-danger btn-rounded">Clear</a>
                            </div>
                        </div>
                    </div>
                </fieldset>
                        ...
                        <div class="col-md-12">
                            <ul class="main-ul">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to select the <strong>Gram Panchayat Name </strong>from the dropdown and the data will be populated from the <strong>Gram Panchayat Master</strong>  and data cascade from <strong>Division Master</strong>, <strong>District Master</strong> and <strong>Block Master</strong> .</li>
                                    </ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>User should be able to select the <strong>Village Name </strong>from the dropdown and the data will be populated from the <strong>Village Master</strong> and data cascade from <strong>Division Master, </strong><strong>District Master, </strong><strong>Block Master</strong> and <strong>Gram Panchayat Master</strong>.</li>
                                    </ul>

                                </li>
                                <li>
                                    <strong>Habitation  Name (In English)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Habitation  Name in English </strong>and the text field should accept <strong>only English letters.</strong> </li>
                                    </ul>

                                </li>

                                <li>
                                    <strong>बस्ती का नाम (हिंदी में)</strong>

                                    <ul>
                                        <li>User should be able to enter the <strong>Habitation  Name in Hindi</strong> and the text field should accept <strong>only Hindi letters.</strong> </li>
                                    </ul>
