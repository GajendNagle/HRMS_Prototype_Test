...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">ब्लॉक वार गणवेश की मांग एवं वितरण की प्रगति
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="GanaveshSHGReportBlockWise.aspx" title="click to go on">Block Uniform Demand & Distribution Progress</a></li>
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a id="diva" class="dropdown-item" href="GanaveshDBTReportDistrictWise.aspx">जिले-वार स्वीकृत प्रगति</a></li>
