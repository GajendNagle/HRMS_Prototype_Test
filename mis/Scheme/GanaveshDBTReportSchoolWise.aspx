...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">स्कूल वार स्वीकृत प्रगति
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="GanaveshDBTReportSchoolWise.aspx" title="click to go on">School Wise Uniform Distribution Report</a></li>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <fieldset>
                        <legend>School Wise Uniform Distribution Report</legend>
                        <div class="row  mt-1">
                            <div class="col-md-3">
