...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor ">जिले-वार गणवेश की मांग एवं वितरण की प्रगति
        ...
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="GanaveshSHGReportDistrictWise.aspx" title="click to go on">District Uniform Demand & Distribution Progress</a></li>
        ...
        <div class="card mt-3 shadow">
            ...
            <div class="card-body">
                ...
                <div class="mt-3">
                    <fieldset>
                        <legend>जिले-वार गणवेश की मांग</legend>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-4 text-center">
                                <div class="form-group">
                                    <button type="button" id="btnShowStudentDetails" class="btn btn-success btn-rounded" onclick="Show();">जिले-वार गणवेश की मांग देखे</button>
                                </div>
                            </div>
                        </div>
                    </fieldset>
