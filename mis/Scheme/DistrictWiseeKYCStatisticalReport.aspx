...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="row page-titles mb-4">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">District Wise eKYC Statistical Report</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">District Wise eKYC Statistical Report</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                <th scope="col" aria-label="स. क्र.: activate to sort column descending" aria-sort="ascending" style="width: 50px;">स. क्र.</th>
                                                <th scope="col"  aria-label="जिला: activate to sort column ascending" style="width: 111px;">जिला</th>
                                                <th scope="col"  aria-label="कुल छात्र: activate to sort column ascending" style="width: 113px;">कुल छात्र</th>
                                                <th scope="col"  aria-label="कुल छात्र जिनकी ई.के.वाई.सी.आवेदन प्राप्त हुआ : activate to sort column ascending" style="width: 320px;">कुल छात्र जिनकी ई.के.वाई.सी.आवेदन प्राप्त हुआ </th>
                                                <th scope="col"  aria-label="कुल छात्र जिनकी ई.के.वाई.सी. अनुमोदित की गई: activate to sort column ascending" style="width: 321px;">कुल छात्र जिनकी ई.के.वाई.सी. अनुमोदित की गई</th>
                                            </tr>
                                        </thead>
                                        <tbody>
