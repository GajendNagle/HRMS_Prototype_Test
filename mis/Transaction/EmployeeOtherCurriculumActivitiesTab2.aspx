...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="card mt-3 shadow">
        ...
        <div class="card-body">
            ...
            <fieldset>
                <legend>राष्ट्रीय/राज्य स्तर के पुरस्कार
                </legend>
                <div class="row">
                    <div class="col-md-3">
      ...
      <br />
                ...
                <fieldset>
                    <legend>राष्ट्रीय/राज्य स्तर के पुरस्कार/सम्मान का विवरण :-</legend>
                            ...
                            <div class="table-responsive table-bordered">
                                <table class="table text-center table table-hover table-bordered">
                                    <tbody>
                                        <tr>
                                            <th>क्र.</th>
                                            <th>सम्मान/पुरस्कार का नाम</th>
                                            <th>पुरस्कार प्राप्ति का वर्ष</th>
                                            <th>आदेश क्रमांक यदि है तो</th>
                                        </tr>
                                        <tr>
                                            <td>1</td>
