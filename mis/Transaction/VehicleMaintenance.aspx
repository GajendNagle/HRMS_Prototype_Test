        ...
        <div class="card-body">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Type /<br />प्रकार<span style="color: red">*</span></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Maintenance Type /<br />रखरखाव का प्रकार<span style="color: red">*</span></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Previous Reading(Km) /<br />पिछली रीडिंग(किमी)</span>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Previous Bill Date /<br />पिछला बिल दिनांक</span>
                            <input type="date" class="form-control" >
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Previous Bill Amount /<br />पिछला बिल राशि</span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Bill Number /<br />बिल संख्या<span style="color: red">*</span></span>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Bill Date /<br />बिल की तिथि<span style="color: red">*</span></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Bill Amount /<br />बिल राशि<span style="color: red">*</span></span>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <span>Upload File /<br />फ़ाइल अपलोड करें<span style="color: red">*</span> <span id="ctl00_ContentBody_filesizeTechnical" style="color: red;"></span></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <span>Vehicle Expenses Details /<br />वाहन व्यय विवरण<span style="color: red">*</span></span>
